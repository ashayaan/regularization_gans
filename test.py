...
# @Last Modified time: 2019-12-29 11:16:52
...
folder = '/home/shayaan/Columbia/sem_1/convolutional_gans/Data/png'

pngLocation = 'Fixed_results'

root = 'outputConditionalGANs/'
model = 'DCGAN_conditional_run1_'
...
print(code_dir)
print("--------------------------")
output_dir = code_dir + 'outputConditionalGANs/'
